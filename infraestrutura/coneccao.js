...
var tabelas = [
    ...
    'CREATE TABLE IF NOT EXISTS T_loja_online (id SERIAL PRIMARY KEY , ID_compra integer NOT NULL, ID_cliente int not null, ARR_produtos varchar(30)[] not NULL, BO_checkout bolean default FALSE, JS_dados_financeiros JSON default NULL, occured_at int default extract(epoch from now()));',
