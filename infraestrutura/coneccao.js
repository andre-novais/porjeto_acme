...
var tabelas = [
    ...
    'CREATE TABLE IF NOT EXISTS T_loja_online (id SERIAL PRIMARY KEY , ID_compra int NOT NULL, ID_cliente int not null, JS_produtos JSONB not NULL, BO_checkout boolean default FALSE, JS_dados_financeiros JSONB default NULL, occured_at int default extract(epoch from now()));',
